...
export default function AssignmentsPage() {
  ...
  // Fetch Data từ API (Tự động refetch khi classId đổi)
    ...
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-slate-500 animate-in fade-in duration-500">
        <div className="p-6 bg-slate-50 rounded-full mb-6">
          <FilePlus2 className="w-16 h-16 text-slate-200" />
        </div>
  ...
  return (
    <div className="space-y-8 animate-in fade-in-50 pb-20 font-sans max-w-[1440px] mx-auto p-4 md:p-8">
      {/* --- HEADER SECTION --- */}
      ...
      {/* --- FILTER & SEARCH BAR --- */}
      <div className="sticky top-4 z-30 bg-white/80 backdrop-blur-xl p-2 rounded-2xl border border-slate-200/60 shadow-lg shadow-slate-200/20 flex flex-col md:flex-row gap-3 items-center">
        {/* Search Input */}
        <div className="relative flex-1 group w-full">
          ...
          <Input
            ...
            className="pl-12 h-12 bg-slate-50/50 border-slate-200 focus:bg-white focus:border-[#F27124]/50 focus:ring-4 focus:ring-[#F27124]/10 rounded-xl text-base transition-all w-full"
            value={searchTerm}
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center border-2 border-dashed border-slate-100 rounded-[32px] bg-slate-50/30">
            ...
            <div className="flex gap-3">
              <Button
                ...
                variant="outline"
                className="px-6 py-2 rounded-xl border-slate-200 text-slate-600 hover:bg-white hover:text-slate-900 font-bold"
              >
                Xóa bộ lọc
              </Button>
            </div>
