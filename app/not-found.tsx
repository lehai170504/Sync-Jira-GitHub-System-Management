...
export default function NotFound() {
 ...
 <h1 className="text-8xl font-semibold tracking-tighter text-slate-900 group-hover:scale-110 transition-transform duration-500">
 404
 </h1>
 ...
 <span className="text-[8px] font-semibold uppercase text-[#F27124]">
 Security_Verified
 </span>
 </div>
 </div>
 ...
 <Link href="/">
 <Button className="h-14 px-8 bg-slate-900 hover:bg-[#F27124] text-white rounded-2xl font-semibold text-[10px] tracking-widest transition-all shadow-2xl active:scale-95 group uppercase">
 ...
 <Button
 variant="outline"
 className="h-14 px-8 border-slate-200 rounded-2xl font-semibold text-[10px] tracking-widest transition-all hover:bg-slate-50 active:scale-95 uppercase"
 >
