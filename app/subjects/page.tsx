...
export default function SubjectsPage() {
 ...
 <h3 className="text-3xl font-bold tracking-tighter text-slate-900 dark:text-slate-50 ">
 {sub.id}
 </h3>
 </div>
 </CardHeader>
 ...
 <h4 className="font-bold text-sm text-slate-800 dark:text-slate-200 mb-3 line-clamp-1 tracking-tight">
 {sub.name}
 </h4>
