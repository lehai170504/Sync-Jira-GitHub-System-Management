...
export function CourseHeader({ title, description, icon }: CourseHeaderProps) {
 ...
 />
 <div className="px-1.5 py-0.5 rounded border border-slate-200 dark:border-slate-700 text-[9px] text-slate-400 dark:text-slate-500 font-semibold transition-colors">
 /
 </div>
 </div>
 </div>
 ...
 <span className="text-sm font-semibold text-slate-900 dark:text-slate-100 leading-tight tracking-tighter transition-colors">
 ...
 className="object-cover"
 />
 <AvatarFallback className="bg-[#F27124]/10 dark:bg-[#F27124]/20 text-[#F27124] dark:text-orange-400 font-semibold ">
 {user?.full_name?.charAt(0)}
 </AvatarFallback>
 </Avatar>

 <div className="flex flex-col">
 <p className="text-sm font-semibold text-slate-900 dark:text-slate-100 leading-none transition-colors">
 {user?.full_name}
 </p>
