...
export function UserMenuItems({
 ...
 <span className="text-[11px] font-bold text-slate-700 dark:text-slate-200 group-hover:text-[#F27124] dark:group-hover:text-orange-400 transition-colors">
 Hồ sơ cá nhân
 </span>
 </div>
 ...
 <span className="text-[11px] font-bold text-slate-700 dark:text-slate-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
 Lớp học của tôi
 </span>
 </div>
 ...
 className="group flex items-center gap-3 p-3 rounded-2xl cursor-pointer text-rose-600 dark:text-rose-400 focus:bg-rose-50 dark:focus:bg-rose-900/20 focus:text-rose-700 dark:focus:text-rose-300 font-semibold relative overflow-hidden transition-all duration-300 active:scale-95"
 >
