...
export function AuthBanner({ isRegisterMode, onToggle }: AuthBannerProps) {
 ...
 <span className="text-[8px] font-semibold uppercase tracking-[0.3em] text-emerald-400">
 {isRegisterMode ? "ĐÃ CÓ TÀI KHOẢN?" : "THÀNH VIÊN MỚI?"}
 </span>
 </div>

 <h2 className="text-4xl font-semibold leading-[0.95] tracking-tighter uppercase ">
 {isRegisterMode ? (
 <>
 Trở lại với <br />
 ...
 onClick={onToggle}
 variant="outline"
 className="mt-4 border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/10 hover:text-emerald-300 h-12 px-8 rounded-2xl font-semibold uppercase tracking-widest text-[10px] transition-all active:scale-95"
 >
