...
export function LoginForm() {
 ...
 <h1 className="text-xl font-semibold tracking-tighter text-slate-900 dark:text-slate-100 uppercase transition-colors">
 Đăng nhập hệ thống
 </h1>
 ...
 type="submit"
 disabled={isPending}
 className="w-full h-12 bg-slate-900 dark:bg-[#F27124] hover:bg-[#F27124] dark:hover:bg-[#d65d1b] text-white rounded-xl font-semibold text-[10px] tracking-widest shadow-lg dark:shadow-none active:scale-95 transition-all uppercase"
 >
 {isLoginPending ? (
 ...
 <span className="flex-shrink mx-3 text-[8px] font-semibold uppercase text-slate-300 dark:text-slate-600 tracking-widest">
 Hoặc đăng nhập với
 </span>
 <div className="flex-grow border-t border-slate-100 dark:border-slate-800"></div>
 </div>
