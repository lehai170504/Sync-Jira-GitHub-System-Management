...
export function IntegrationTab() {
  ...
  return (
    <div className="space-y-10 font-mono animate-in fade-in slide-in-from-top-4 duration-700">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-200/60 dark:border-slate-800 p-8 shadow-sm transition-colors">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <LinkIcon className="w-4 h-4 text-[#F27124] dark:text-orange-400" />
              <h3 className="text-[12px] font-black uppercase tracking-[0.3em] text-slate-900 dark:text-slate-100">
                Bảng điều khiển tích hợp
              </h3>
            </div>
            <p className="text-[11px] text-slate-500 dark:text-slate-400 font-medium uppercase tracking-wider opacity-70 max-w-xl leading-relaxed">
          ...
          <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-950/50 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
            <Cpu className="w-5 h-5 text-emerald-500 dark:text-emerald-400 animate-pulse" />
            <div className="flex flex-col">
              <span className="text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">
                Trạng thái
              </span>
              <span className="text-[10px] font-black text-slate-900 dark:text-slate-100 uppercase">
                Hệ thống hoạt động
              </span>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-200/60 dark:border-slate-800 overflow-hidden shadow-sm transition-colors">
        ...
        >
          ...
          <div className="border-b border-slate-100 dark:border-slate-800 bg-slate-50/30 dark:bg-slate-950/30 transition-colors">
          ...
          <div className="p-8">
            <div className="flex items-center gap-3 mb-8 opacity-50 dark:opacity-70">
              <Zap className="w-3 h-3 text-[#F27124] dark:text-orange-400" />
