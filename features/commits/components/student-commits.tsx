...
import { CommitPatchModal } from "@/features/commits/components/commit-patch-modal";
import { getValidation } from "@/features/commits/utils/utils";
import { UserRole } from "@/components/layouts/sidebar-config";
import type { CommitItem } from "@/features/commits/types/commits-types";
  ...
  return (
    <div className="space-y-8 w-full py-8 px-4 md:px-0 animate-in fade-in duration-700 text-slate-900 dark:text-slate-100">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-50 uppercase">
            Commit
          </h2>
...
function StatItem({
  ...
  return (
    ...
    >
      <div>
        <p className="text-[10px] font-semibold uppercase tracking-[0.2em] opacity-60 mb-1">
          {label}
        </p>
