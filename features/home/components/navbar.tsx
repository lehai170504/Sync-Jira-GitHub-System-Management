...
export function Navbar() {
  ...
  return (
    <header
      className={`px-8 h-24 flex items-center justify-between fixed w-full top-0 z-50 transition-all duration-500 ${
        scrolled
    ...
    >
      <div className="flex items-center gap-8">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="relative h-14 w-auto transition-all duration-500 group-hover:scale-105 active:scale-95">
            <Image
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-4">
          <Link href="/login">
            <Button
              variant="ghost"
              className="hidden sm:flex text-slate-600 dark:text-slate-400 hover:text-slate-950 dark:hover:text-white font-bold uppercase text-[11px] tracking-widest transition-all"
            >
              Đăng nhập
            </Button>
          </Link>
