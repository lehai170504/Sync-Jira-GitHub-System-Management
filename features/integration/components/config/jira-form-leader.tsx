    ...
    <div className="font-mono space-y-6">
      {isConnected ? (
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-200/60 dark:border-slate-800 p-8 shadow-sm dark:shadow-none transition-colors">
        ...
        <div className="flex flex-col items-center justify-center p-12 bg-slate-50/50 dark:bg-slate-900/60 rounded-[40px] border-2 border-dashed border-slate-200 dark:border-slate-700 space-y-6">
          <div className="p-5 bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700">
...
function InfoBox({ icon: Icon, label, value }: any) {
  return (
    <div className="p-5 bg-slate-50/50 dark:bg-slate-900/60 rounded-2xl border border-slate-100 dark:border-slate-800 group hover:bg-white dark:hover:bg-slate-900 hover:border-[#0052CC]/20 transition-all">
      <div className="flex items-center gap-3 mb-2">
        <Icon className="h-3.5 w-3.5 text-slate-400 dark:text-slate-500 group-hover:text-[#0052CC] transition-colors" />
