...
export function TeamReviewDialog({
 ...
 <DialogTitle className="text-xl md:text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-50">
 ...
 {data && (
 <Badge className="bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300 border-emerald-100 dark:border-emerald-800 text-[10px] font-semibold uppercase tracking-widest px-2 py-1 h-auto shrink-0">
