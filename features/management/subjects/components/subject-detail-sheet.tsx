                ...
                <SheetHeader className="px-6 py-6 border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-950 shrink-0 shadow-sm z-10 text-left">
                    <div className="flex flex-col gap-3 items-start">
                        <div className="flex items-center gap-2">
                            <Badge className="bg-[#F27124]/10 dark:bg-[#F27124]/20 text-[#F27124] hover:bg-[#F27124]/15 border-none font-semibold text-[10px] tracking-widest px-2.5 py-1">
                                {subject?.code || "CODE"}
                            </Badge>
                            <StatusBadge status={subject?.status || "Status"} />
                        </div>
                        ...
                        <div className="p-6 space-y-8 pb-20">
                            ...
                            <section className="space-y-4">
                                <div className="flex items-center justify-between px-1">
                                    <h4 className="text-sm font-semibold uppercase tracking-tight text-slate-900 dark:text-slate-100">
                                ...
                                <div className="grid gap-3">
                                        ...
                                        >
                                            ...
                                            <div className="flex justify-between items-start">
                                                <div className="flex items-center gap-3">
                                                    <div className="h-10 w-10 rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-[#F27124] font-semibold text-xs border border-slate-100 dark:border-slate-700">
                                                        {cls.name.substring(0, 2).toUpperCase()}
                                                    </div>
                                                    <div>
                                                        <p className="text-sm font-semibold text-slate-900 dark:text-slate-100 leading-tight group-hover:text-[#F27124] transition-colors">
                                                            {cls.name}
                                                        </p>
                                                ...
                                                {cls.lecturer_id ? (
                                                    <div className="flex items-center gap-2 pl-4 border-l border-slate-100 dark:border-slate-800">
                                                        ...
                                                        <Avatar className="h-8 w-8 border border-white dark:border-slate-700 shadow-sm">
                                                            ...
                                                            <AvatarFallback className="text-[9px] font-semibold bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400">
                                                                {cls.lecturer_id.full_name.charAt(0)}
                                                            </AvatarFallback>
                                                        </Avatar>
                                                    </div>
                                                ) : (
                                                    <div className="flex items-center gap-1.5 text-xs text-slate-400 dark:text-slate-500 bg-slate-50 dark:bg-slate-800 px-2 py-1 rounded-lg">
                                    ...
                                    {classes?.length === 0 && (
                                        <div className="text-center py-10 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-[24px] bg-white/50 dark:bg-slate-900/50">
                                            <p className="text-sm font-bold text-slate-300 dark:text-slate-600 ">
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-[24px] border border-slate-100 dark:border-slate-800 shadow-sm flex flex-col justify-between h-full transition-colors">
            ...
            <div>
                ...
                <div className="flex items-baseline gap-1">
                    <p className="text-2xl font-semibold text-slate-900 dark:text-slate-50 tracking-tighter">
                        {value || 0}
                    </p>
                    {subText && (
