...
export function TeamDetailSheet({
 ...
 <Badge
 variant="outline"
 className="bg-orange-50 dark:bg-orange-900/10 text-[#F27124] dark:text-orange-400 border-orange-100 dark:border-orange-900/30 font-semibold uppercase text-[10px] tracking-widest"
 >
 Team Profile
 </Badge>
 {team?.last_sync_at && (
 ...
 <div className="space-y-1">
 <SheetTitle className="text-3xl font-semibold text-slate-900 dark:text-slate-50 tracking-tighter leading-tight">
 ...
 <h3 className="text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500 ml-1">
 Kênh tích hợp
 </h3>
 ...
 <TabsTrigger
 value="members"
 className="flex-1 rounded-xl text-[11px] font-semibold uppercase tracking-wider data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:text-slate-900 dark:data-[state=active]:text-slate-100 data-[state=active]:shadow-md transition-all text-slate-500 dark:text-slate-400"
 >
 Thành viên
 </TabsTrigger>
 ...
 <TabsTrigger
 value="reviews"
 className="flex-1 rounded-xl text-[11px] font-semibold uppercase tracking-wider data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:text-[#F27124] dark:data-[state=active]:text-orange-400 data-[state=active]:shadow-md transition-all text-slate-500 dark:text-slate-400"
 >
 Đánh giá
 </TabsTrigger>
 ...
 <Button
 className="flex-1 h-12 bg-slate-900 hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 text-white font-semibold rounded-2xl shadow-lg shadow-slate-200 dark:shadow-none transition-all active:scale-95"
 ...
 <Button
 className="flex-1 h-12 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-2xl shadow-lg shadow-blue-100 dark:shadow-none transition-all active:scale-95"
...
function StatCard({ icon: Icon, label, value, color }: any) {
 ...
 <p className="text-[10px] font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-widest leading-none mb-1.5">
 {label}
 </p>
...
function ConnectionRow({
 ...
 <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500 leading-none mb-1.5">
 {label}
 </p>
 <p
 className={cn(
...
function MemberItem({ mem }: { mem: TeamMemberDetail }) {
 ...
 <AvatarFallback className="bg-slate-50 dark:bg-slate-800 text-slate-400 dark:text-slate-500 font-semibold">
 ...
 <Badge className="bg-yellow-400 dark:bg-yellow-900/30 text-yellow-900 dark:text-yellow-500 hover:bg-yellow-400 border-none text-[9px] font-semibold uppercase px-2 py-0 h-4">
 Leader
 </Badge>
 )}
 </div>
...
function SyncHistoryLogs({ history }: { history: SyncHistoryLog[] }) {
 ...
 return (
 <div className="text-center py-12 text-slate-300 dark:text-slate-600 font-bold">
 ...
 : "Đồng bộ Thành công"}
 {idx === 0 && (
 <Badge className="text-[9px] font-semibold h-4 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 border-none">
 Mới nhất
 </Badge>
 )}
 </p>
