...
import type { Member } from "@/features/tasks/types/tasks-types";
import { useJiraIssueCommits } from "@/features/integration/hooks/use-jira-issue-commits";
import { mapStatusToStatusName } from "@/features/tasks/utils/utils";
import type { TaskStatus } from "@/features/tasks/types/tasks-types";
              ...
              <ScrollArea className="h-full">
                <div className="space-y-5 pr-3">
                  <div className="flex items-center gap-3 py-1">
                    ...
                    <StatusBadge status={mapStatusToStatusName(task.status)} />
                  </div>
                  <div className="flex items-center gap-3 py-1">
